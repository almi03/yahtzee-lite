...
function startGame() 
{
	...
	// prepare the GUI
	// DCH: I did this already in start() -- not needed - RESOLVED
	// but you do want to communicate to the player by adding text
	//
...
function rollDice() 
{
   ...
   // DCH: same mistake as above on the keeper 
	for (var i = 0; i < numberDice; ++i) {
	   if (!keeper[i]) {
   ...
   */
   ...
   // AND take appropriate action
	...
	// DCH: you need to call gameover and create the message there
	// the button resetting happens in startgame, not here
